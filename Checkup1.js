document.getElementById('test-form').addEventListener('submit', function(event) {
    ...
    if (haemoglobin < 16.5) {
        resultText = 'Possible indication of anemia.';
        diseaseInfo += '<strong>Anemia:</strong> Low haemoglobin levels.<br>';
    }
    if (eosinophils > 6) {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [
                    haemoglobin, neutrophils, lymphocytes, eosinophils, monocytes, basophils, rbc, pcv, mcv, mch, mchc, plateletCount
                ],
